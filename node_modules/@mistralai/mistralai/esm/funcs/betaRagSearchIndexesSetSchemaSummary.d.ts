 ...
 */
export declare function betaRagSearchIndexesSetSchemaSummary(client: MistralCore, request: operations.SetSchemaSummaryV1RagIndexesIndexIndexIdSchemasSchemaSchemaIdSummaryFieldLanguagePutRequest, options?: RequestOptions): APIPromise<Result<any, errors.HTTPValidationError | MistralError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=betaRagSearchIndexesSetSchemaSummary.d.ts.map