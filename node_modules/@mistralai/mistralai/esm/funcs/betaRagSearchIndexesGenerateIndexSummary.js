 ...
 */
export function betaRagSearchIndexesGenerateIndexSummary(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/rag/indexes/index/{index_id}/summary_field/{language}")(pathParams);
    ...
    const context = {
        ...
        operationID: "generate_index_summary_v1_rag_indexes_index__index_id__summary_field__language__post",
        oAuth2Scopes: null,
...
//# sourceMappingURL=betaRagSearchIndexesGenerateIndexSummary.js.map